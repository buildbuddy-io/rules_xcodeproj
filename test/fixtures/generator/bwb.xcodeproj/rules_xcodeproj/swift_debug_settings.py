...
_SETTINGS = {
  "$(BUILD_DIR)/bazel-out/darwin_x86_64-dbg-ST-e86416d3a8c7/bin/tools/generator/generator" : {
    "clang" : "-iquote \"$(PROJECT_DIR)\" -iquote \"$(BAZEL_OUT)/darwin_x86_64-dbg-ST-e86416d3a8c7/bin\" -O0 -DDEBUG=1 -fstack-protector -fstack-protector-all -iquote \"$(PROJECT_DIR)\" -iquote \"$(BAZEL_OUT)/darwin_x86_64-dbg-ST-e86416d3a8c7/bin\" -O0 -DDEBUG=1 -fstack-protector -fstack-protector-all -iquote \"$(PROJECT_DIR)\" -iquote \"$(BAZEL_OUT)/darwin_x86_64-dbg-ST-e86416d3a8c7/bin\" -O0 -DDEBUG=1 -fstack-protector -fstack-protector-all -iquote \"$(PROJECT_DIR)\" -iquote \"$(BAZEL_OUT)/darwin_x86_64-dbg-ST-e86416d3a8c7/bin\" -O0 -DDEBUG=1 -fstack-protector -fstack-protector-all -iquote \"$(PROJECT_DIR)\" -iquote \"$(BAZEL_OUT)/darwin_x86_64-dbg-ST-e86416d3a8c7/bin\" -O0 -DDEBUG=1 -fstack-protector -fstack-protector-all",
    "frameworks" : [

    ],
    "includes" : [
      "$(BAZEL_OUT)/darwin_x86_64-dbg-ST-e86416d3a8c7/bin/external/com_github_apple_swift_collections",
      "$(BAZEL_OUT)/darwin_x86_64-dbg-ST-e86416d3a8c7/bin/external/com_github_tuist_xcodeproj",
      "$(BAZEL_OUT)/darwin_x86_64-dbg-ST-e86416d3a8c7/bin/external/com_github_tadija_aexml",
      "$(BAZEL_OUT)/darwin_x86_64-dbg-ST-e86416d3a8c7/bin/external/com_github_kylef_pathkit"
    ]
  },
  "$(BUILD_DIR)/bazel-out/darwin_x86_64-dbg-ST-e86416d3a8c7/bin/tools/generator/test/tests.xctest/Contents/MacOS/tests" : {
    "clang" : "-iquote \"$(PROJECT_DIR)\" -iquote \"$(BAZEL_OUT)/darwin_x86_64-dbg-ST-e86416d3a8c7/bin\" -O0 -DDEBUG=1 -fstack-protector -fstack-protector-all -iquote \"$(PROJECT_DIR)\" -iquote \"$(BAZEL_OUT)/darwin_x86_64-dbg-ST-e86416d3a8c7/bin\" -O0 -DDEBUG=1 -fstack-protector -fstack-protector-all -iquote \"$(PROJECT_DIR)\" -iquote \"$(BAZEL_OUT)/darwin_x86_64-dbg-ST-e86416d3a8c7/bin\" -O0 -DDEBUG=1 -fstack-protector -fstack-protector-all -iquote \"$(PROJECT_DIR)\" -iquote \"$(BAZEL_OUT)/darwin_x86_64-dbg-ST-e86416d3a8c7/bin\" -O0 -DDEBUG=1 -fstack-protector -fstack-protector-all -iquote \"$(PROJECT_DIR)\" -iquote \"$(BAZEL_OUT)/darwin_x86_64-dbg-ST-e86416d3a8c7/bin\" -O0 -DDEBUG=1 -fstack-protector -fstack-protector-all -iquote \"$(PROJECT_DIR)\" -iquote \"$(BAZEL_OUT)/darwin_x86_64-dbg-ST-e86416d3a8c7/bin\" -O0 -DDEBUG=1 -fstack-protector -fstack-protector-all -iquote \"$(PROJECT_DIR)\" -iquote \"$(BAZEL_OUT)/darwin_x86_64-dbg-ST-e86416d3a8c7/bin\" -O0 -DDEBUG=1 -fstack-protector -fstack-protector-all -iquote \"$(PROJECT_DIR)\" -iquote \"$(BAZEL_OUT)/darwin_x86_64-dbg-ST-e86416d3a8c7/bin\" -O0 -DDEBUG=1 -fstack-protector -fstack-protector-all",
    "frameworks" : [
    ...
    "includes" : [
      ...
      "$(BAZEL_OUT)/darwin_x86_64-dbg-ST-e86416d3a8c7/bin/external/com_github_pointfreeco_swift_custom_dump",
      "$(BAZEL_OUT)/darwin_x86_64-dbg-ST-e86416d3a8c7/bin/external/com_github_apple_swift_collections",
      "$(BAZEL_OUT)/darwin_x86_64-dbg-ST-e86416d3a8c7/bin/external/com_github_tuist_xcodeproj",
      "$(BAZEL_OUT)/darwin_x86_64-dbg-ST-e86416d3a8c7/bin/external/com_github_tadija_aexml",
      "$(BAZEL_OUT)/darwin_x86_64-dbg-ST-e86416d3a8c7/bin/external/com_github_kylef_pathkit",
      "$(BAZEL_OUT)/darwin_x86_64-dbg-ST-e86416d3a8c7/bin/external/com_github_pointfreeco_xctest_dynamic_overlay"
    ]
  }
}
